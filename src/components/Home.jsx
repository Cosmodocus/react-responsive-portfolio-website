        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full '>
            ...
            <h2 className='text-4xl sm:text-7xl font-bold text-[#8892b0]'>
              I'm a <ReactTyped 
                    ...
                    backSpeed={120}
                    loop
                    className ='text-4xl sm:text-7xl font-bold text-[#00b894]'
                    />
            </h2>
            ...
            <div>
                <button className='text-white group border-2 rounded-2xl px-6 py-3 my-2 flex items-center hover:bg-[#00b894]  hover:border-[#00b894] ' onclick="window.location.href='https://www.example.com'">View Work 
