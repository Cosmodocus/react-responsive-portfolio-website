...
const Home = () => {
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]' style={{ borderBottom: '2px solid #8892b0' }}>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full '>
            ...
            <div>
                <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#00b894]  hover:border-[#00b894] '>View Work 
