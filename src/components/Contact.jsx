    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/ce66e89a-16f3-40dd-8203-ad8630371ad6" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                ...
                <p className='text-gray-300 py-4 font-bold'>Submit the form below to contact me — or reach me at homayunir@gmail.com</p>
            </div>
            <input className='bg-[#ccd6f6] p-2 rounded-2xl font-bold' type="text" placeholder='Name' name='name' />
            <input className='my-4 p-2 bg-[#ccd6f6] rounded-2xl font-bold' type="email" placeholder='Email' name='email' />
            <textarea className='bg-[#ccd6f6] p-2 rounded-xl font-bold'
